...
Проект работает на [Django 5.0](https://www.djangoproject.com/). 
Сейчас очень нужна помощь с моделированием системы, почитать о котором можно [здесь](https://docs.djangoproject.com/en/5.0/intro/tutorial02/#creating-models).
